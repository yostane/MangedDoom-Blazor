...
function precache() {
  return caches.open(CACHE).then((cache) => {
    return cache.addAll([
      ...
      "./_framework/BlazorDoom.4hkuefvfz5.wasm",
      "./_framework/BlazorDoom.75fctktndg.wasm",
      "./_framework/BlazorDoom.c7furw59de.wasm",
      "./_framework/BlazorDoom.f2vohqc73o.wasm",
      "./_framework/BlazorDoom.g2hwd863hb.wasm",
      "./_framework/BlazorDoom.i8rpfweebe.wasm",
      "./_framework/BlazorDoom.wrs9wdw20l.wasm",
      ...
      "./slides/slides-commitconf-2023-managed-doom-blazor-6692bf.html",
      "./slides/slides-doom-blazor-long.html",
